...
//  Output :            Integer
//  Author :            Mangesh Parakash Shinde
//  Date :              25/09/2023  
//
///////////////////////////////////////////////////////////////////
...
{
    auto int iSum = 0;          //variable to store the Value of addition
    iSum = iNo1 + iNo2;
    return iSum;
...
///////////////////////////////////////////////////////////////////
//
//  Entry Point function of appllication which perform additon of 2 integer
//
///////////////////////////////////////////////////////////////////
